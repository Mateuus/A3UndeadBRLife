private ["_eh1","_inArea","_zone1","_zone2","_zone3","_zone4","_zone5","_zone6","_zone7","_zone8","_zone9","_zone1dis","_zone2dis","_zone3dis","_zone4dis","_zone5dis","_zone6dis","_zone7dis","_zone8dis","_zone9dis","_dis"];
...
_zone9 = getMarkerPos "safezone_vip";
...
_enterText = "Voce esta entrando em uma zona segura!";
_leaveText = "Voce esta saindo de uma zona segura!";
