...
class Clothing {
    class bruce {
        ...
        uniforms[] = {
            ...
            { "U_C_man_sport_1_F", "Sport a", 2500, { "", "", -1 } },
			{ "U_C_U_C_man_sport_2_F", "Sport b", 2500, { "", "", -1 } },
			{ "U_C_man_sport_3_F", "Sport c", 2500, { "", "", -1 } },
			{ "U_C_Man_casual_1_F", "Casual a", 1500, { "", "", -1 } },
			{ "U_C_Man_casual_2_F", "Casual b", 1500, { "", "", -1 } },
			{ "U_C_Man_casual_3_F", "Casual c", 1500, { "", "", -1 } },
			{ "U_C_Man_casual_4_F", "Casual d", 1500, { "", "", -1 } },
			{ "U_C_Man_casual_5_F", "Casual e", 1500, { "", "", -1 } },
			{ "U_C_Man_casual_6_F", "Casual f", 1500, { "", "", -1 } },
			{ "U_I_C_Soldier_Bandit_4_F", "Roupa 1", 3000, { "", "", -1 } },
			{ "U_I_C_Soldier_Bandit_2_F", "Roupa 2", 3000, { "", "", -1 } },
			{ "U_I_C_Soldier_Bandit_1_F", "Roupa 3", 3000, { "", "", -1 } },
	...
	class roupasgangue3 {
        title = "Loja de Roupas de Gangue 3";
        license = "";
        side = "civ";
        uniforms[] = {
			{ "NONE", "Remove Uniform", 0, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_B_CombatUniform_mcam", "Roupa VIP V", 5500, { "life_gangdonorid", "SCALAR", 1 } },
            { "U_B_CombatUniform_mcam_vest", "Roupa VIP V", 5500, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_I_CombatUniform", "Roupa Padrão VIP", 1000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_C_Poloshirt_blue", "Undead Brasil Roupa", 5250, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_O_OfficerUniform_ocamo", "ROUPA VIP V", 5275,  { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_O_GhillieSuit", "ROUPA VIP V", 9150, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_O_FullGhillie_sard", "ROUPA VIP V", 14175, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_O_FullGhillie_lsh", "ROUPA VIP V", 14125, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_O_FullGhillie_ard", "ROUPA VIP V", 14350, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_MillerBody", "ROUPA VIP V", 5250, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_Marshal", "ROUPA VIP V", 5650, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_KerryBody", "ROUPA VIP V",5735, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_IG_leader", "ROUPA VIP V", 5701, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_C_Driver_1", "ROUPA VIP V", 5100, { "life_gangdonorid", "SCALAR", 1 } },
            { "U_I_C_Soldier_Para_1_F", "", 10000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_I_C_Soldier_Para_2_F", "", 10000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_I_C_Soldier_Para_3_F", "", 10000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_I_C_Soldier_Para_4_F", "", 10000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_I_C_Soldier_Para_5_F", "", 10000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_I_C_Soldier_Bandit_3_F", "", 10000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_I_C_Soldier_Bandit_5_F", "", 10000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_B_T_Soldier_F", "", 10000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_B_T_Soldier__AR_F", "", 10000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_B_T_Soldier_SL_F", "", 10000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_O_T_Soldier_Viper_F", "", 50000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_O_T_Soldier_Viper_hex_F", "", 50000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "U_BG_leader", "ROUPA VIP V", 5500, { "life_gangdonorid", "SCALAR", 1 } }

        };
		headgear[] = {
            { "NONE", "Remove Hat", 0, { "life_gangdonorid", "SCALAR", 1 } },
			{ "H_Watchcap_camo", "", 150, { "life_gangdonorid", "SCALAR", 1 } },
			{ "H_Watchcap_sgg", "", 150, { "life_gangdonorid", "SCALAR", 1 } },
			{ "H_Watchcap_khk", "", 150, { "life_gangdonorid", "SCALAR", 1 } },
			{ "H_Shemag_khk", "", 1500, { "life_gangdonorid", "SCALAR", 1 } },
			{ "H_Shemag_tan", "", 1500, { "life_gangdonorid", "SCALAR", 1 } },
			{ "H_Shemag_olive_hs", "", 1500, { "life_gangdonorid", "SCALAR", 1 } },
			{ "H_ShemagOpen_khk", "", 1500, { "life_gangdonorid", "SCALAR", 1 } },
        ...
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, { "life_gangdonorid", "SCALAR", 1 } },
            { "B_Bergen_mcamo", "Mochila Gay", 2500, { "life_gangdonorid", "SCALAR", 1 } },
			{ "B_Bergen_sgg", "Mochila USA", 2500, { "life_gangdonorid", "SCALAR", 1 } },
			{ "B_Kitbag_mcamo", "", 3450, { "life_gangdonorid", "SCALAR", 1 } },
			{ "B_TacticalPack_oli", "", 1500, { "life_gangdonorid", "SCALAR", 1 } },
			{ "B_FieldPack_ocamo", "", 2700, { "life_gangdonorid", "SCALAR", 1 } },
			{ "B_Carryall_oli", "", 3000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "B_Carryall_khk", "", 3000, { "life_gangdonorid", "SCALAR", 1 } },
			{ "B_Carryall_oucamo", "", 3000, { "life_gangdonorid", "SCALAR", 1 } }
        };
    };
