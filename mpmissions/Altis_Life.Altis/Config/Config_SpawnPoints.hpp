...
class CfgSpawnPoints {
    class Civilian {
		...
		class GangVip2 {
            ...
            spawnMarker = "civ_spawn_gang_2";
            icon = "icons\ranks\gang\2.paa";
            licenses[] = { { "", true } };
		...
		class GangVip3 {
            displayName = "ViperS";
            spawnMarker = "civ_spawn_gang_3";
            icon = "icons\ranks\gang\3.paa";
            licenses[] = { { "", true } };
            level[] = { "life_gangdonorid", "EQUAL", 3 };
        };
		
		class GangVip4 {
            displayName = "BrFOX";
            spawnMarker = "civ_spawn_gang_4";
            icon = "icons\ranks\gang\4.paa";
            licenses[] = { { "", true } };
            level[] = { "life_gangdonorid", "EQUAL", 4 };
        };
