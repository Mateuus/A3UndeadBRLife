...
class WeaponShops {
	...
	class diamante {
		...
		items[] = {
			...
			{ "arifle_CTAR_hex_F", "CAR-95 5.8MM", 150000, 7500 },
			{ "srifle_DMR_07_hex_F", "CMR-76 5.8MM", 150000, 7500 },
			{ "LMG_03_F", "LIM-85 5.56mm", 150000, 7500 },
			{ "arifle_AK12_F", "AK-12 7.62mm", 150000, 7500 },
