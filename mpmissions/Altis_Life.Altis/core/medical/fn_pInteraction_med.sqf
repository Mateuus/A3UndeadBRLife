...
private["_display","_curTarget","_Btn1","_Btn2","_Btn3","_Btn4","_Btn5","_Btn6","_Btn8"];
if(!dialog) then {
...
//Set Revive Button
_Btn3 ctrlSetText localize "STR_pInAct_Rev";
_Btn3 buttonSetAction "[life_pInact_curTarget] call life_fnc_revivePlayer;";
...
if(!((_curTarget isKindOf "Man") && (!alive _curTarget) && (_curTarget GVAR["Revive",false]))) then  {
	_Btn3 ctrlEnable false;
};*/
