...
/* System Settings */
    ...
    vehicleShop_rentalOnly[] = { "B_MRAP_01_hmg_F", "B_Boat_Armed_01_minigun_F", "O_MRAP_02_hmg_F" }; //Vehicles that can only be rented and not purchased. (Last only for the session)
		...
		vehicle_rental_multiplier_DONATOR_GOLD     = .2;  //Doador Vehicle Rental Price = Config_Vehicle price * multiplier
		vehicle_rental_multiplier_DONATOR_PLATINUM = .1;  //Doador Vehicle Rental Price = Config_Vehicle price * multiplier
