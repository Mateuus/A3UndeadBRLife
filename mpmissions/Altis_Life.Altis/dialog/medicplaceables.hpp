class Life_Medic_Placeables {

    idd = 20000;
    name= "life_medic_placeables";
    movingEnable = false;
    ...
    class controls {
        ...
        class RemoveAll : life_RscButtonMenu {
            ...
            onButtonClick = "[] call life_fnc_medicplaceablesRemoveAll";
        ...
        class Place : Life_RscButtonMenu {
            ...
            onButtonClick = "[] spawn life_fnc_medicplaceablePlace;";
            x = 0.32;
            y = 0.69;
            w = (6.25 / 40);
            h = (1 / 25);
